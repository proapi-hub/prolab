...
const logoRules: [RegExp, string][] = [
  ...
  // 快手 Kling 系列（必须放在 OpenAI 之前；kling-o3 含 "o3" 会被 OpenAI 规则误匹配）
  [/(kling|keling)/i, 'keling.png'],
  ...
  [/(qwen|qwq|qvq|wan[-\d])/i, 'qwen.png'],  // wan 后接连字符或数字（wan2-7 / wan-2 / wan2.5）
  [/gemma/i, 'gemma.png'],
  [/yi-/i, 'yi.png'],
  [/llama/i, 'llama.png'],
  ...
  [/gemini/i, 'gemini.png'],
  [/nano-banana/i, 'gemini.png'],   // Gemini 系图像（nano-banana / -2 / -pro）
  [/imagen/i, 'google.png'],         // Google Imagen 系（google-imagen-4 等）
  [/bison/i, 'palm.png'],
  [/palm/i, 'palm.png'],
  [/step/i, 'step.png'],
  [/hailuo/i, 'hailuo.png'],
  ...
  [/chirp/i, 'suno.png'],
  [/luma/i, 'luma.png'],
  // （keling / kling 规则已上移到 OpenAI 规则之前）
  [/seedance/i, 'byte_dance.svg'],
  [/byte-plus/i, 'byte_dance.svg'],   // byte-plus-seedream-* 系列字节跳动图像
  [/vidu-/i, 'vidu.png'],
  [/ai21/i, 'ai21.png'],
  [/jamba-/i, 'ai21.png'],
  [/nvidia/i, 'nvidia.png'],
